...
17. Pro Version supports preorders,alipay,bitcoin and customer creation for each order, make sure you do a <a href="mailto:nazrulhassanmca@gmail.com">**Presales Query**</a> before buying.
18. This plugin supports the **<a href="http://www.cartspan.com/">CartSpan</a> QuickBooks accounting integration** by providing detailed payment methods for account reconciliation. This functionality is not available with any other payment gateway or WooCommerce accounting integration.
