...
#flash_sale-shortcodes-form-tab_accordion .flash_sale-shortcodes-toggle-icon-list { margin: 0 0 10px 0; }\
		...
		<div class="flash_sale-shortcodes-form-types">\
			<ul>\
				<li class="flash_sale-shortcodes-form-type-button active" type="product_rule"><a href="#">Products Carousel By Rule</a></li>\
				...
				<li class="flash_sale-shortcodes-form-type-social" type="product_rule_auto"><a href="#">Products Grid by Rule</a></li>\
			</ul>\
		</div><!-- end types -->\
...
<!-- top_products Grid-->\
			<div class="flash_sale-shortcodes-form-tab" id="flash_sale-shortcodes-form-tab_product_rule_auto">\
				<h2>Add products</h2>\
				<div class="flash_sale-shortcodes-form-fields">\
				<table cellpadding="0" cellspacing="0">\
					<tr>\
