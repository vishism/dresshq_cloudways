...
class pw_woocommerc_flashsale_WC_Admin_Tabs {
	...
	public function pw_woocommerce_brands_add_tab_woocommerce($tabs){
		...
		$tabs['pw_flash_sale'] = __('Flash Sale','pw_wc_flash_sale'); // or whatever you fancy
		return $tabs;
	}
	...
	public function settings_init_brand() {
		add_settings_field(
			...
			__( 'Product Brand base', 'pw_wc_flash_sale' ), 	// setting title
	...
	public function product_brand_slug_input() {
		...
		//echo $perm;
		?>
		<input name="woocommerce_product_flashsale_slug" type="text" class="regular-text code" value="<?php if ( isset( $perm ) ) echo esc_attr( $perm ); ?>" placeholder="<?php echo _x('product-brand', 'slug', 'pw_wc_flash_sale') ?>" />
		<?php
	}	
	...
	public function pw_woocommerce_brands_add_page_setting_woocommerce( $settings ) {
		...
		$settings[] = array(
			...
			'desc' 		=> __( 'Page contents: [pw_woocommerce_brands]', 'pw_wc_flash_sale' ),
	...
	private function pw_woocommerce_brands_plugin_options() {
		$options['general_settings'] = array(
			array( 'name' => __( 'General Settings', 'pw_wc_flash_sale' ), 'type' => 'title', 'desc' => '', 'id' => 'pw_woocommerce_brands_general_settings' ),
			array(
				'name'      => __( 'Style Count Down', 'woocommerce-brands' , 'pw_wc_flash_sale'),
				'desc'      => __( 'Choose Count Down', 'pw_wc_flash_sale' ),
				'id'        => 'pw_woocommerce_flashsale_countdown',
				'type'      => 'select',
				'class'		=> 'chosen_select',
				'css' 		=> 'min-width:300px;',
				'options'   => array(
					'style1' => __( 'Style 1', 'pw_wc_flash_sale' ),
					'style2' => __( 'Style 2', 'pw_wc_flash_sale' ),
					'style3' => __( 'Style 3', 'pw_wc_flash_sale' ),
				),
				'desc_tip'	=>  true
			),
			array(
				'name'      => __( 'Show Count Down Single', 'pw_wc_flash_sale' ),
				'desc'      => __( 'Show Count Down Single.', 'pw_wc_flash_sale'), 
			...
			array(
				'name'      => __( 'Show Count Down Archive', 'pw_wc_flash_sale' ),
				'desc'      => __( 'Show Count Down Archive', 'pw_wc_flash_sale'), 
			...
			array(
				'title' => __( 'Colour', 'pw_wc_flash_sale' ),
				'desc' 		=> __( 'The base colour for Dark Skin Colour. Default<code>#414141</code>.','pw_wc_flash_sale'  ),
			...
			array(
				'name'      => __( 'Font Size', 'woocommerce-brands' , 'pw_wc_flash_sale'),
				'desc'      => __( 'Font Size For CountDown', 'pw_wc_flash_sale' ),
				'id'        => 'pw_woocommerce_flashsale_fontsize_countdown',
				'type'      => 'select',
				'class'		=> 'chosen_select',
				'css' 		=> 'min-width:300px;',
				'options'   => array(
					'small' => __( 'Small', 'pw_wc_flash_sale' ),
					'medium' => __( 'Medium', 'woocommerce-brands' ),
					'large' => __( 'Large', 'pw_wc_flash_sale' ),
				),
				'desc_tip'	=>  true
			),
