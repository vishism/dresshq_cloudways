...
ulp_active_window_id].after_submit_success()}catch(n){}if("undefined"!=typeof b.forms){var d=b.forms,f;for(f in d)d.hasOwnProperty(f)&&(jQuery("body").append(d[f]),jQuery("#submit-"+f).click())}ulp_track(ulp_active_window_id,"layered-popup","subscribe",jQuery("#ulp-"+ulp_active_window_id).find('[name="ulp-email"]').val());_ulp_open(ulp_active_window_id,!1,!1);d=0;b.close_delay&&(d=b.close_delay);ulp_unlock_links(ulp_active_window_id);var g=b.return_url;0<ulp_forced_location.length&&(g=ulp_forced_location);
var k=b.thanksgiving_popup;setTimeout(function(){0<g.length?(ulp_self_close(),ulp_subscribing=!1,"#refresh"==g?location.reload(!0):location.href=g):0<k.length?(ulp_subscribing=!1,ulp_open(k)):(ulp_self_close(),ulp_subscribing=!1)},d)}else if("ERROR"==c){ulp_subscribing=!1;if(ulp_custom_handlers.hasOwnProperty("ulp-"+ulp_active_window_id)&&ulp_custom_handlers["ulp-"+ulp_active_window_id].hasOwnProperty("after_submit_fail")&&"function"==typeof ulp_custom_handlers["ulp-"+ulp_active_window_id].after_submit_fail){ulp_custom_handlers["ulp-"+
...
function ulp_init(){var a=window.location.hash,b=a.indexOf("#ulp-");0>b&&(b=a.indexOf("#ulpx-"));if(0<=b&&(b=a.indexOf("#ulp-"),0<=b?a=a.substr(b+5):(b=a.indexOf("#ulpx-"),a=a.substr(b+6)),0<a.length)){var d=!1;b=a.indexOf(":");if(0<b){var c=a.substr(b+1);a=a.substr(0,b);a=ulp_popup_id(a);0<c.length&&(b=ulp_read_cookie("ulp-"+a),c=ulp_decode64(c),b==ulp_cookie_value?(location.href=c,d=!0):ulp_forced_location=c)}d||(ulp_open(a),ulp_onload_displayed=!0)}ulp_inline_open(!1);jQuery.ajax({url:ulp_ajax_url,
data:{action:"ulp-init","post-id":ulp_content_id},type:"POST",async:!0,success:function(a){try{var b="object"==typeof a?a:jQuery.parseJSON(a);if("OK"==b.status){ulp_onload_popup=b.event_data.onload_popup;ulp_onload_mode=b.event_data.onload_mode;ulp_onload_period=b.event_data.onload_period;ulp_onscroll_popup=b.event_data.onscroll_popup;ulp_onscroll_mode=b.event_data.onscroll_mode;ulp_onscroll_period=b.event_data.onscroll_period;ulp_onexit_popup=b.event_data.onexit_popup;ulp_onexit_mode=b.event_data.onexit_mode;
ulp_onexit_period=b.event_data.onexit_period;ulp_onidle_popup=b.event_data.onidle_popup;ulp_onidle_mode=b.event_data.onidle_mode;ulp_onidle_period=b.event_data.onidle_period;ulp_onabd_popup=b.event_data.onabd_popup;ulp_onabd_mode=b.event_data.onabd_mode;ulp_onabd_period=b.event_data.onabd_period;ulp_onload_delay=b.event_data.onload_delay;ulp_onload_close_delay=b.event_data.onload_close_delay;ulp_onscroll_offset=b.event_data.onscroll_offset;ulp_onidle_delay=b.event_data.onidle_delay;b.footer&&jQuery("body").append(b.footer);
ulp_prepare_ids();var d=ulp_read_cookie("ulp-onabd-"+ulp_onabd_popup);""==ulp_onabd_popup||"none"==ulp_onabd_mode||d==ulp_cookie_value||ulp_active_window_id||ulp_no_preload_loading||ulp_onabd_displayed||"undefined"!=typeof ulp_noadb||("once-session"==ulp_onabd_mode?ulp_write_cookie("ulp-onabd-"+ulp_onabd_popup,ulp_cookie_value,0):"once-only"==ulp_onabd_mode?ulp_write_cookie("ulp-onabd-"+ulp_onabd_popup,ulp_cookie_value,180):"once-period"==ulp_onabd_mode&&ulp_write_cookie("ulp-onabd-"+ulp_onabd_popup,
ulp_cookie_value,ulp_onabd_period),ulp_open(ulp_onabd_popup),ulp_onabd_displayed=!0);var c=ulp_read_cookie("ulp-onload-"+ulp_onload_popup);""!=ulp_onload_popup&&"none"!=ulp_onload_mode&&c!=ulp_cookie_value&&(0>=parseInt(ulp_onload_delay,10)?ulp_onload_open(ulp_onload_popup):setTimeout(function(){ulp_onload_open(ulp_onload_popup)},1E3*parseInt(ulp_onload_delay,10)));var f=ulp_read_cookie("ulp-onexit-"+ulp_onexit_popup);""!=ulp_onexit_popup&&"none"!=ulp_onexit_mode&&f!=ulp_cookie_value&&jQuery(document).bind("mouseleave",
...
!0)});var m=ulp_read_cookie("ulp-onscroll-"+ulp_onscroll_popup);""!=ulp_onscroll_popup&&"none"!=ulp_onscroll_mode&&m!=ulp_cookie_value&&jQuery(window).scroll(function(a){if(!ulp_active_window_id&&!ulp_no_preload_loading&&!ulp_onscroll_displayed){a=jQuery(window).scrollTop();var b=parseInt(ulp_onscroll_offset,10);0<ulp_onscroll_offset.indexOf("%")&&(100<b&&(b=100),b=parseInt((jQuery(document).height()-jQuery(window).height())*b/100,10));a>b&&("once-session"==ulp_onscroll_mode?ulp_write_cookie("ulp-onscroll-"+
ulp_onscroll_popup,ulp_cookie_value,0):"once-only"==ulp_onscroll_mode?ulp_write_cookie("ulp-onscroll-"+ulp_onscroll_popup,ulp_cookie_value,180):"once-period"==ulp_onscroll_mode&&ulp_write_cookie("ulp-onscroll-"+ulp_onscroll_popup,ulp_cookie_value,ulp_onscroll_period),ulp_open(ulp_onscroll_popup),ulp_onscroll_displayed=!0)}});var l=ulp_read_cookie("ulp-onidle-"+ulp_onidle_popup);""!=ulp_onidle_popup&&"none"!=ulp_onidle_mode&&l!=ulp_cookie_value&&(jQuery(window).mousemove(function(a){ulp_onidle_counter=
0}),jQuery(window).click(function(a){ulp_onidle_counter=0}),jQuery(window).keypress(function(a){ulp_onidle_counter=0}),jQuery(window).scroll(function(a){ulp_onidle_counter=0}),ulp_onidle_timer=setTimeout("ulp_onidle_counter_handler();",1E3))}}catch(r){console.log(r)}}})}
