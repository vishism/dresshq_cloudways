	...
	function init() {
		...
		if ($ulp->ext_options['minified_sources'] == 'on') {
			...
			if ($ulp->options['perfectscrollbar_enable'] == 'on') {
				$return_data['resources']['css'][] = $ulp->plugins_url.'/css/perfect-scrollbar.min.css?ver='.ULP_VERSION;
				$return_data['resources']['js'][] = $ulp->plugins_url.'/js/perfect-scrollbar.jquery.min.js?ver='.ULP_VERSION;
			}
			...
			if ($ulp->options['perfectscrollbar_enable'] == 'on') {
				...
				$return_data['resources']['js'][] = $ulp->plugins_url.'/js/perfect-scrollbar.jquery.js?ver='.ULP_VERSION;
			}
