     jQuery(document).ready(function($) {
         ...
         $("#help13").click(function(){
          ...
          //v1.0.9.3 begin 
           ...
           $("#help66").click(function(){
              $("#help66-text").toggle("slow");                           
          });          
           $("#help67").click(function(){
              $("#help67-text").toggle("slow");                           
          });          
           $("#help68").click(function(){
              $("#help68-text").toggle("slow");                           
          });          
           $("#help69").click(function(){
              $("#help69-text").toggle("slow");                           
          });
          //v1.0.9.3 bend                         
      });  
