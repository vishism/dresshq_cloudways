    ...
    */  
    $vtprd_edit_arrays_framework = array (
      ...
      'buy_group_framework'  => array ( 		  
         ...
         'buy_group_customer_found'            	    => false, //v2.0.1.0  used in Customer level rule pre-processing in FRONT END ONLY  
         'buy_group_products_set_to_include_exclude_both_none'  => false, //v2.0.2.0  values: includeOnly || excludeOnly || both (include and exclude found) || none = neither include nor exclude found 
         'buy_group_customer_set_to_include_exclude_both_none'  => false  //v2.0.2.0  values: includeOnly || excludeOnly || both (include and exclude found) || none = neither include nor exclude found                           
       ),
      ...
      'action_group_framework'  => array (             
         ...
         'action_group_products_set_to_include_exclude_both_none'  => false //v2.0.2.0  values: includeOnly || excludeOnly || both (include and exclude found) || none = neither include nor exclude found          
       ),
