  ...
  if(!class_exists('Ult_Content_Box')) {
	class Ult_Content_Box {
		...
		function ult_content_box_scripts() {
		  wp_register_style( 'ult_content_box_css', plugins_url('../assets/css/content-box.css',__FILE__) );
		  wp_register_script('ult_content_box_js', plugins_url('../assets/js/content-box.js',__FILE__) , array('jquery'), ULTIMATE_VERSION, true);
		}
	}
