...
if(!class_exists('Ultimate_Info_Banner')) 
{
	class Ultimate_Info_Banner{
		...
		{
			wp_register_script('utl-info-banner-script',plugins_url('../assets/min-js/info-banner.min.js',__FILE__),array('jquery','ultimate-appear'), ULTIMATE_VERSION);
			wp_register_style('utl-info-banner-style',plugins_url('../assets/min-css/info-banner.min.css',__FILE__),array(), ULTIMATE_VERSION);
		}
