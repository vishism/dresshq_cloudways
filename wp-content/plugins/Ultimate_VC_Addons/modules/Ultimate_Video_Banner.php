...
if(!class_exists('Ultimate_Video_Banner')) {
	class Ultimate_Video_Banner {
		...
		function register_video_banner_assets() {
			wp_register_style('ultimate-video-banner-style',plugins_url('../assets/min-css/video-banner.min.css',__FILE__),array(),ULTIMATE_VERSION);
			wp_register_script('ultimate-video-banner-script',plugins_url('../assets/min-js/video-banner.min.js',__FILE__),array('jquery'),ULTIMATE_VERSION);
		}
