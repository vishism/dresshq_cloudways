...
/*------------ accordian border style --------------*/	
		...
		//echo $icon_position;
			if($icon_position=='Right')
				...
				$newtab .='<li class="ult_tab_li '.$ult_style.' '.$ul_sub_class.' " data-iconcolor="'.$icon_color.'" data-iconhover="'.$icon_hover_color.'" style="'.$link_li_style.'">
					<a href="#'.$tab_id.'" style="color:'.$tab_title_color.';'.$bgcolor.';'.$style5bgcolor.' '.$tab_css.'" class="ult_a '.$css_class .'">
	...
	/*-------------------accordion right icon------------------*/
        	...
        	<a class="ult-tabto-actitle withBorder ult_a" style="color:'.$tab_title_color.';'.$style5bgcolor.';background-color:'.$tab_background_color.';'.$ult_ac_border.'" href="#'.$tab_id.'">
...
/*-------------------accordion left icon------------------*/
        	...
        	<a class="ult-tabto-actitle withBorder ult_a" style="color:'.$tab_title_color.';'.$style5bgcolor.';background-color:'.$tab_background_color.';'.$ult_ac_border.'" href="#'.$tab_id.'">
				...
				{
					$newtab .='<li class="ult_tab_li '.$ult_style.' '.$ul_sub_class.'" data-iconcolor="'.$icon_color.'" data-iconhover="'.$icon_hover_color.'" style="'.$link_li_style.'">
					<a href="#'.$tab_id.'" style="color:'.$tab_title_color.';'.$bgcolor.';'.$style5bgcolor.' '.$tab_css.'" class="ult_a '.$icon_top_link.' '.$css_class .'">
...
/*-------------------accordion top icon------------------*/
	        	...
	        	<a class="ult-tabto-actitle withBorder ult_a" style="color:'.$tab_title_color.';'.$style5bgcolor.';background-color:'.$tab_background_color.';'.$ult_ac_border.'" href="#'.$tab_id.'">
					...
					$icon_position='none';
					$newtab .='<li class="ult_tab_li '.$ult_style.' '.$ul_sub_class.'" data-iconcolor="'.$icon_color.'" data-iconhover="'.$icon_hover_color.'" style="'.$link_li_style.'">
					<a href="#'.$tab_id.'" style="color:'.$tab_title_color.';'.$bgcolor.';'.$style5bgcolor.' '.$tab_css.' " class="ult_a '.$ult_style.' '.$css_class .'">
					     <span class="ult_tab_main '.$resp_style.' ">
					 		 <span class="ult_tab_section">
