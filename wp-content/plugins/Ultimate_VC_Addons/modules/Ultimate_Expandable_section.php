...
if(!class_exists('AIO_ultimate_exp_section')) 
{
...

	{
		...
		function ultimate_exp_scripts(){
			...
			wp_register_style( 'style_ultimate_expsection', plugins_url('../assets/min-css/expandablesecton.min.css', __FILE__) );
			wp_register_script("jquery_ultimate_expsection",plugins_url("../assets/min-js/expandable_section.min.js",__FILE__),array('jquery','jquery_ui'),ULTIMATE_VERSION);
			wp_register_script("jquery_ui",plugins_url("../assets/js/jquery-ui.js",__FILE__),array('jquery'),ULTIMATE_VERSION);
				...
				vc_map(
					array(
					    ...
					    "content_element" => true,
					     'front_enqueue_css' => plugins_url('../assets/min-css/expandablesecton.min.css', __FILE__),
					    "front_enqueue_js"=>plugins_url("../assets/min-js/expandable_section.min.js",__FILE__),
						"controls" => "full",
