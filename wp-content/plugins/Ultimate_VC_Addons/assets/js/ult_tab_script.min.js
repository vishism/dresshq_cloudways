...
function setmytime(){
   ...
   //for link and to tab 
    ...
    if(type!='')
    {
      ...
      var iconcolor=bgcontain.find("li").data('iconcolor');
      if(aciveicon=='')
      var aciveicon=bgcontain.find("li").data('iconhover');
 

      bgcontain.find("li").removeClass("current");
      maintab.parent().addClass("current");
      bgcontain.find("a").css({'background-color':normbgcolor});
      bgcontain.find("a").css({'color':titlecolor});
