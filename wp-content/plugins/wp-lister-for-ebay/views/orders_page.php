...
<div class="wrap">
	...
	<form method="post" action="<?php echo $wpl_form_action; ?>">
		...
		<div id="wpl_advanced_order_options" class="submit" style="display:none; padding-top: 0; float:left; clear:both">
            ...
            <p>
                <label for="wple_download_order_numbers" class="text_label">Download these order numbers (comma-separated):</label>
                <br/>
                <textarea name="wple_download_order_numbers" id="wple_download_order_numbers" rows="3" cols="30"></textarea>
                <br/>
                <select name="wple_download_from_account">
                    <option value="">Select account to download from</option>
                    <?php foreach ( WPLE()->accounts as $account ) : ?>
                        <option value="<?php echo $account->id; ?>"><?php echo $account->title .' ('. $account->site_code .')'; ?></option>
                    <?php endforeach; ?>
                </select>
            </p>
		</div>
