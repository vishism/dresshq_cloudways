	...
	select.select_shipping_type {
		...
		font-size: 12px;
					...
					<div class="postbox" id="ShippingOptionsBox">
						<h3 class="hndle"><span><?php echo __( 'Shipping Options', 'wp-lister-for-ebay' ); ?></span>
                            ...
                            <?php wplister_tooltip(__('<b>Shipping Service Type</b><br>
                            						...
                            						Currently, FreightFlat is available only for the US, UK, AU, CA and CAFR sites, and only for domestic shipping. On the US site, FreightFlat applies to shipping with carriers that are not affiliated with eBay.', 'wp-lister-for-ebay')) ?>
						</h3>
						<div class="inside">
					...
					<div class="postbox" id="IntShippingOptionsBox">
						<h3 class="hndle"><span><?php echo __( 'International shipping', 'wp-lister-for-ebay' ); ?></span></h3>
						<div class="inside">
