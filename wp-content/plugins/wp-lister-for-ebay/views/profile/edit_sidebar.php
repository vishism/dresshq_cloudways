						...
						<div class="inside">
							...
							<div id="wpl-custom_quantity_container">
                                ...
                                <select id="wpl-restrict_fixed_quantity" name="wpl_e2e_restrict_fixed_quantity" class="select">
                                    <option value=""  <?php if ( @$item_details['restrict_fixed_quantity'] == '' ): ?>selected="selected"<?php endif; ?>><?php echo __( 'All', 'wp-lister-for-ebay' ); ?></option>
                                    <option value="1" <?php if ( @$item_details['restrict_fixed_quantity'] == '1' ): ?>selected="selected"<?php endif; ?>><?php echo __( 'In Stock', 'wp-lister-for-ebay' ); ?></option>
                                    <option value="2" <?php if ( @$item_details['restrict_fixed_quantity'] == '2' ): ?>selected="selected"<?php endif; ?>><?php echo __( 'Unmanaged Stock', 'wp-lister-for-ebay' ); ?></option>
                                </select>
					...
					<div class="postbox" id="OtherSettingsBox">
						...
						<div class="inside">
							...
							<label for="wpl-text-counter_style" class="text_label">
                                ...
                                <?php wplister_tooltip(__('Select which kind of hit counter your want displayed on your listing page.<br><br>
                                						Note: The number of page views will not be available if you select "no hit counter". To make the number of views available to your eyes only choose "Hidden Counter".', 'wp-lister-for-ebay')) ?>
							</label>
