...
<body>
    ...
    <?php else : ?>
        <p>
            <?php echo sprintf( __( 'There were no products found for query %s.', 'wp-lister-for-ebay' ), $wpl_query ) ?>
        </p>
    <?php endif; ?>
    ...
    <script type="text/javascript">
        ...
        jQuery('#wplister_matcher_query_select').change(function(){
            ...
            jQuery('#wplister_matcher_query_input').prop('value', selected_property );
