...
//------------------------------------------------------------------------------
    ...
    var LobiboxBase = {
        ...
        _createMarkup: function () {
            ...
            lobibox.prop('data-is-modal', me.$options.modal);
        ...
        _enableDrag: function () {
            ...
            heading.on('mousedown.lobibox', function (ev) {
                el.prop('offset-left', ev.offsetX);
                el.prop('offset-top', ev.offsetY);
                el.prop('allow-drag', 'true');
            });
            $(document).on('mouseup.lobibox', function () {
                el.prop('allow-drag', 'false');
            });
            $(document).on('mousemove.lobibox', function (ev) {
                if (el.prop('allow-drag') === 'true') {
                    var left = ev.clientX - parseInt(el.prop('offset-left'), 10) - parseInt(el.css('border-left-width'), 10);
                    var top = ev.clientY - parseInt(el.prop('offset-top'), 10) - parseInt(el.css('border-top-width'), 10);
                    el.css({
                        left: left,
                        top: top
                    });
        ...
        _afterShow: function () {
            var me = this;
            Lobibox.counter++;
            me.$el.prop('data-nth', Lobibox.counter);
