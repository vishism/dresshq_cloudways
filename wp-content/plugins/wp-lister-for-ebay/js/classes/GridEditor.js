...
WPLGE.GridController = (function () {
    ...
    var listing_profile_map = []; 
    jQuery.map(listing_profiles, function(profile, idx){
      listing_profile_map[ profile.pid ] = profile.text;
    });
    ...
    function profileCellRenderer(params) {
      ...
      return listing_profile_map[params.value] ? listing_profile_map[params.value] : '---'; 
    }    
