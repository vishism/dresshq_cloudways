...
class ReturnPolicyResponse implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'return_policies' => '\Swagger\Client\Model\ReturnPolicy[]',
...
'warnings' => 'getWarnings'    ];
     ...
     *
     * @param \Swagger\Client\Model\ReturnPolicy[] $return_policies A list of elements, where each contains a category ID and a flag that indicates whether or not listings in that category require a return policy.
     *
     * @return $this
     */
