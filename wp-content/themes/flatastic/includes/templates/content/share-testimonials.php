...
if (!mad_custom_get_option('share-testimonials-enable'))
	return;
...
<div class="share-links-wrapper v_centered">
	...
	<div class="share-links">
		...
		<?php if (mad_custom_get_option('share-testimonials-facebook')): ?>
		...
		<?php if (mad_custom_get_option('share-testimonials-twitter')): ?>
		...
		<?php if (mad_custom_get_option('share-testimonials-linkedin')): ?>
		...
		<?php if (mad_custom_get_option('share-testimonials-googleplus')): ?>
		...
		<?php if (mad_custom_get_option('share-testimonials-pinterest')): ?>
		...
		<?php if (mad_custom_get_option('share-testimonials-vk')): ?>
		...
		<?php if (mad_custom_get_option('share-testimonials-tumblr')): ?>
		...
		<?php if (mad_custom_get_option('share-testimonials-reddit')): ?>
		...
		<?php if (mad_custom_get_option('share-testimonials-xing')): ?>
