...
if (!mad_custom_get_option('share-portfolio-enable'))
	return;
...
<div class="share-links-wrapper v_centered">
	...
	<div class="share-links">
		...
		<?php if (mad_custom_get_option('share-portfolio-facebook')): ?>
		...
		<?php if (mad_custom_get_option('share-portfolio-twitter')): ?>
		...
		<?php if (mad_custom_get_option('share-portfolio-linkedin')): ?>
		...
		<?php if (mad_custom_get_option('share-portfolio-googleplus')): ?>
		...
		<?php if (mad_custom_get_option('share-portfolio-pinterest')): ?>
		...
		<?php if (mad_custom_get_option('share-portfolio-vk')): ?>
		...
		<?php if (mad_custom_get_option('share-portfolio-tumblr')): ?>
		...
		<?php if (mad_custom_get_option('share-portfolio-reddit')): ?>
		...
		<?php if (mad_custom_get_option('share-portfolio-xing')): ?>
