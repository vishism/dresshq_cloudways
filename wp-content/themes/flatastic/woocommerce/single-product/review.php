	...
	<div id="comment-<?php comment_ID(); ?>" class="comment_container">
		...
		<div class="comment-text">
			...
			<?php else : ?>
				...
				<p class="meta">
					<span itemprop="author">By <?php comment_author(); ?></span>
					<?php
					...
					?>
					- <time itemprop="datePublished" datetime="<?php echo get_comment_date( 'c' ); ?>"><?php echo get_comment_date('l, j F Y'); ?></time>
